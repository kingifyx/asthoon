        ...
        return when (tab) {
            ...
            Tab.DUNGEON -> when (activeDungeonSection) {
                DungeonSection.GENERAL -> listOf(
                    ...
                    ToggleRow("Starred Mob ESP", "Highlights starred mobs with Devonian-style boxes",
                    ...
                    ToggleRow("  ↳ Shadow Assassin", "Highlight Shadow Assassins",
                        { Config.starMobSa }, { Config.starMobSa = it }),
                    ...
                    ToggleRow("  ↳ Minibosses", "Highlight Lost Adventurers, Midas, Diamond Guy",
                        { Config.starMobMiniboss }, { Config.starMobMiniboss = it }),
                    ToggleRow("  ↳ Chunky Mobs", "Highlight Withermancers, Lords, Commanders, Archers",
                        { Config.starMobChonk }, { Config.starMobChonk = it }),
                    ToggleRow("  ↳ Skeleton Masters", "Highlight Skeleton Masters",
                        { Config.starMobSm }, { Config.starMobSm = it }),
                    ToggleRow("  ↳ Fels", "Highlight Fels (including invisible)",
                        { Config.starMobFel }, { Config.starMobFel = it }),
                    ToggleRow("  ↳ Regular Star Mobs", "Highlight all other starred mobs",
                        { Config.starMobRegular }, { Config.starMobRegular = it }),
                )
